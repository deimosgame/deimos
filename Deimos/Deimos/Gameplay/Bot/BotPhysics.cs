...
namespace Deimos
{
    class BotPhysics
    {
        ...
        public float initial_velocity = 0f;
        ...
        // Constructor
        public BotPhysics(DeimosGame game, Bot thisBot)
        {
            Game = game;
            ThisBot = thisBot;
        }
        ...
        private float GetMaxHorizAcceleration()
        {
            ...
            switch (ThisBot.CurrentSpeedState)
            {
        ...
        public void Jump(bool propulsion)
        {
            ...
            if (ThisBot.CurrentSpeedState == Player.SpeedState.Sprinting)
            {
                ThisBot.CurrentSpeedState = Player.SpeedState.Running;
            }
