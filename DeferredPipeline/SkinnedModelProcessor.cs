...
namespace DeferredPipeline
{
    ...
    public class SkinnedModelProcessor : ModelProcessor
    {
        ...
        /// </summary>
        public ModelContent Process(NodeContent input,
                                             ...
                                             bool animated)
        {
            ...
            if (!Animated)
            {
                context.Logger.LogImportantMessage(">>>>>>>>>>>>>> No animation, returning directly.");

                ModelContent modelWithout = base.Process(input, context);
                modelWithout.Tag = null;
